...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>SandBoxAfterRefreshScript</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SandBoxAfterRefreshScriptTest</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SonOfGod</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>TryOut</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <custom>true</custom>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Case.Requirements__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Account-Service Vendor Account Layout</layout>
        <recordType>Account.Service_Vendor</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Case-Change Request Case Layout</layout>
        <recordType>Case.Change_Request</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Product Case Layout</layout>
    ...
    <layoutAssignments>
        <layout>Contact-Standard Contact Layout</layout>
        <recordType>Contact.Standard</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Contact-Technician Contact Layout</layout>
        <recordType>Contact.Technician</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Opportunity-New%2FAdd-On Business Opportunity Layout</layout>
        <recordType>Opportunity.New_Add_On_Business</recordType>
    </layoutAssignments>
    <layoutAssignments>
